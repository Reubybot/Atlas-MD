...
global.packname = process.env.PACKNAME || `REUBY.MD`;
global.author = process.env.AUTHOR || "by: DR REUBY";
...
global.mess = {
  jobdone: "Job done by DR REUBY...",
  useradmin: "DR REUBY warns!, only *Group Admins* can use this command *Baka*!",
  botadmin:
    "Sorry, DR REUBY execute this command without being an *Admin* of this group.",
  botowner: "Only *DR REUBY* can use this command, Baka!",
  grouponly: "This command is only made for *Groups*, Baka!",
  privateonly: "This command is only made for *Private Chat*, Baka!",
  botonly: "Only the *Bot itself* can use this command!",
  waiting: "PLEASE WAIT DR REUBY IS PROCESSING...",
  nolink: "Please provide DR REUBY *link*, Baka!",
  error: "An error occured!",
  banned: `You are *Banned* fron using commands!  \n\nType *${prefa}owner* or *${prefa}support* to submit a request to unban yourself !`,
  bangc: "This Group is *Banned* from using Commands!",
  nonsfw: "DR REUBY hates perverts Baka! This is not a NSFW enabled group!",
};
